...
public class NarrowTransferRecyclerViewAdapter
        extends RecyclerView.Adapter<NarrowTransferRecyclerViewAdapter.CustomItemViewAdapter> {

    private List<PendingFile> mPendingFileList;
    private RecyclerView mRecyclerView;
    private Context mContext;

    public NarrowTransferRecyclerViewAdapter(Context iContext, PendingFile[] iPendingFiles, RecyclerView iRecyclerView) {
        mPendingFileList = Arrays.asList(iPendingFiles);
        mRecyclerView = iRecyclerView;
        mContext = iContext;
    }

    public NarrowTransferRecyclerViewAdapter(Context iContext, RecyclerView iRecyclerView) {
